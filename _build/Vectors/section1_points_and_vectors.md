...
A __point__ $A$ with the __coordinates__ $x, y$ and $z$, written $A(x \vert y \vert z)$, indicates a *position* in space relative to the coordinate system. For example, point $A(3 \lvert 4 \lvert 5)$ can be found as follows: Starting at the origin, 
